    ...
    let opcion = null;
    let id, username, email, rol, password, password_confirm,row;
    ...
    let datatable = $('#datatable').DataTable({
        ...
        "columns": [
            ...
            { "data": "Email" },
            { "data": "Rol" },
            { "defaultContent": "<button type='button' class='btn btn-primary btn_edit' data-toggle='modal' data-target='#edit_modal'><i class='fas fa-edit'></i></button> <button class='btn btn-danger btn_delete'><i class='fas fa-trash - alt'></i> </button>" }
        ]
    });
    ...
    */
    ...
    $('#form').submit(function (e) {
        ...
        console.log(id, username, email, rol)
    ...
    */
    ...
    $('#form_create').submit(function (e) {
        ...
        password_confirm = $('#password_confirm_create').val();
